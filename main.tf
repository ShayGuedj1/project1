...
connection {
    ...
    private_key = file("/var/lib/jenkins/workspace/projects.pem")  # Path to your private key
    host        = self.public_ip  # Use the public IP of the instance
  }

provisioner "file" {
    source      = "/var/lib/jenkins/workspace/id_rsa.pub"  # Path to your local public key
